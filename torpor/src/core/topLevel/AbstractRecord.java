...
public abstract class AbstractRecord<R extends Record> implements Record {
	...
	protected AbstractRecord(Class<R> clazz, String schema, ResultSet rs) {
		try {
			...
			//ExceptionHandler.logException(Bundle.get(Bundle.EXC, "couldNotInstantiateRecord"), e);
		}
	}
	...
	public boolean create() {
		try {
			...
			try {
				...
				//ExceptionHandler.logException(Bundle.get(Bundle.EXC, "SchemaNotCreated"), e);
			}
